...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (Ubuntu 4.9.2-10ubuntu13) 4.9.2'
...
grub_target_cppflags=' -Wall -W -I$(top_srcdir)/include -I$(top_builddir)/include  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/4.9/include'
